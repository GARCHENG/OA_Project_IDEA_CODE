			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<table class="table table-bordered table-striped" width="800px">
						<tr>
							<td>帐号</td>
							<td><input onblur="searchUsernameIsSame(this.value)" class="form-control" name="name" placeholder="名称"></td>
						</tr>
						<tr>
							<td>初始密码</td>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" >
	...
	<script type="text/javascript">
		...
		function searchUsernameIsSame(username) {
			$.post("checkUsername", { name: username},
					function(data){
		...
		$("#permissionForm").validate({
			...
			messages: {
				name: "<span style=\"color: red\">不能为空!</span>",
				password: "<span style=\"color: red\">不能为空!</span>",
				email: "<span style=\"color: red\">不能为空!</span>",
			}
		});
	</script>
</div>
