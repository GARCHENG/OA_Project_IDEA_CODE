...
<div class="page-content">
    <form id="addRoleForm" class="form-inline" action="saveRoleAndPermissions" method="post">
...
<script>
	...
	$("#permissionForm").validate({
		...
		messages: {
			name: "<span style=\"color: red\">不能为空!</span>",
			url:"<span style=\"color: red\">不能为空!</span>",
			percode:"<span style=\"color: red\">不能为空!</span>",
		}
	});
</script>
</html>