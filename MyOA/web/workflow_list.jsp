...
<%--	                            <a href="delDeployment?deploymentId=${dep.id}" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> 删除</a>--%>
	                            <button onclick="delDeployment(${dep.id})" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> 删除</button>
	                        </td>
	                    </tr>
					</c:forEach>
                    </tbody>
...
<script>
    function delDeployment(depid) {
        var flag = confirm("确定删除吗?");
        if (flag){
            location="delDeployment?deploymentId="+depid;
        }
